...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		//traemos el valor de la url despues de doctor//
		$valor = substr($_GET["url"], 7);

		$resultado = DoctoresC::DoctorC($columna, $valor); //variable resultado
...
<div class="modal fade" rol="dialog" id="cancelamodal" >
<div class="modal-dialog">
		<div class="modal-content">
				...
				<div class="modal-body">
					<div class="box-body">
						...
						<div class="form-group">
								<h2>Nombre del Paciente:</h2>
								<h4 id="paciente"></h4>
								<input type ="" name="idCita" id="idCita">
								<?php
									$Did = substr($_GET["url"], 7);
									echo'<input type="" name="idDoctor" value="'.$Did.'">';
								/*$exp=explode("/",$_SERVER["REQUEST_URI"]);
								echo'<input type="" name="idDoctor" value="'.$exp[3].'">';*/
								?>
								</div> 
