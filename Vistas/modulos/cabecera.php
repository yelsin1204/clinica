<header class="main-header">
    <!-- Logo -->
    <a href="http://localhost/clinica/inicio" class="logo"  style="background-color: #222d32">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
             ...
             if($_SESSION["foto"] == ""){
                ...
                echo '<img src="http://localhost/clinica/Vistas/img/FOTO.JPG.jpg" class="user-image" alt="User Image">';
