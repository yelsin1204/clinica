	...
	<section class="content">
		...
		<div class="box">
			...
			<div class="box-header">
				...
				<button class="btn btn-primary" data-toggle="modal" data-target="#CrearPaciente">Crear Paciente <i class="fa fa-plus"></i></button>
							...
							echo '<tr>
									...
									<td>
										...
										<div class="btn-group">
											...
											<button class="btn btn-warning EditarPaciente" Pid="'.$value["id"].'" data-toggle="modal" data-target="#EditarPaciente"><i class="fa fa-pencil"></i> Editar</button>
											<td>
