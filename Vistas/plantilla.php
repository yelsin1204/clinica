...
<!-- Site wrapper -->
  ...
  if(isset($_SESSION["Ingresar"]) && $_SESSION["Ingresar"] == true){
    ...
    $url = array(); //atrapamos las url en un array//
    ...
    if(isset($_GET["url"])){
      ...
      || $url[0] == "menuSecretaria" || $url[0] == "menuDoctor" || $url[0] == "Doctor"  ){
      ...
      }else if($_GET["url"] == "menuSecretaria"){
      ...
      include "modulos/consultorios.php";
      include "modulos/Doctor.php";
      include "modulos/E-C.php";
      include "modulos/historial.php";
      include "modulos/ingreso-Administrador.php";
      include "modulos/ingreso-Doctor.php";
      include "modulos/ingreso-Paciente.php";
      include "modulos/ingreso-Secretaria.php";
      include "modulos/inicio-editar.php";
      include "modulos/inicio.php";
  ...
  var date = new Date()
    ...
    var d    = date.getDate(),
        ...
        $('#calendar').fullCalendar({
          //Escondemos los dias domingos y sabados//
              hiddenDays: [0,6],
              
                //escogemos el color de agenda //
                eventColor: '#fb4308',
   ...
   // scrollTime:"08:00",
    minTime: "08:00",
    maxTime: "18:00",
              //y este código se visualizara de la misma manera pero e
     //para poder los eventos que se tsienen esa fecha//
     ...
     dayClick:function(date,jsEvent,view){
      //darle click nos levanta el modal//
      $('#CitaModal').modal();
        ...
        fecha = fecha.split("T"); //separamos la t de la fecha y hora//

        var dia = fecha[0]; //solo trae la fecha //

        var hora = (fecha[1]).split(":"); //solo trae la hora //
        ...
        $('#fechaC').val(dia); //en la modal cita se carga los inputs de modulo cita.php//
        
          $('#horaC').val(h1+":00:00");  //en la modal cita se carga los inputs de modulo cita.php//

           $('#fyhIC').val(fecha[0]+" "+h1+":00:00");   //en la modal cita se carga los inputs de modulo cita.php//

         $('#fyhFC').val(fecha[0]+" "+horaFinal+":00:00"); //en la modal cita se carga los inputs de modulo cita.php//
     },


       //levantamos el modal con los datos//
